...
cprequire_test(["inline:com-chilipeppr-widget-autolevel-smoothie-vt"], function (autolevel) {
    ...
    $('#com-chilipeppr-widget-autolevel-smoothie-vt').css('margin', '30px');
    $('#com-chilipeppr-widget-autolevel-smoothie-vt').css('position', 'relative');
    $('#com-chilipeppr-widget-autolevel-smoothie-vt').css('background', 'none');
...
cpdefine("inline:com-chilipeppr-widget-autolevel-smoothie-vt", ["chilipeppr_ready", "ThreeHelvetiker", "Three"], function () {
