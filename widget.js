...
cprequire_test(["inline:com-chilipeppr-widget-autolevel-smoothie-vt"], function (autolevel) {
    console.log("test running of " + autolevel.id);
    autolevel.init();
    
    $('#widget-autolevel-smoothie-vt').css('margin', '30px');
    $('#widget-autolevel-smoothie-vt').css('position', 'relative');
    $('#widget-autolevel-smoothie-vt').css('background', 'none');
...
cpdefine("inline:widget-autolevel-smoothie-vt", ["chilipeppr_ready", "ThreeHelvetiker", "Three"], function () {
    ...
    return {
        ...
        init: function () {
            ...
            // setup del files
            $('#widget-autolevel-smoothie-vt .recent-file-delete').click( this.deleteRecentFiles.bind(this));

            this.buildRecentFileMenu();
            
            // paste loader
            $('#widget-autolevel-smoothie-vt .dropdown-menu .paste-load').click(function(e) {
                e.stopPropagation();
            });
            var that = this;
            $('#widget-autolevel-smoothie-vt .dropdown-menu .paste-load-go').click(function(e) {
                that.loadText();
            });
        ...
        loadText: function() {
            ...
            var data = $('#widget-autolevel-smoothie-vt .dropdown-menu .paste-load').val();
            var name = "Paste: ";
        ...
        buildRecentFileMenu: function() {
            ...
            $('#widget-autolevel-smoothie-vt .dropdown-menu2 > li.recent-file-item').remove();
            
            var li = $('#widget-autolevel-smoothie-vt .dropdown-menu2 > li.recent-files');
